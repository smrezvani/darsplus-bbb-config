...
cd /var/www/bigbluebutton-default && rm -rf * && wget -bqc https://github.com/smrezvani/bbb-default-page/archive/main.zip

sleep 5

unzip -qq main.zip && rm -rf main.zip && mv bbb-default-page-main/* . && rm -rf bbb-default-page-main
